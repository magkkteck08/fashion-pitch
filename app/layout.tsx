    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans w-full">
      ...
      >
        ...
        <div className="p-4 border-t border-slate-800">
          <Link 
            href="/" 
            className="flex items-center gap-3 px-4 py-3 rounded-md text-xs font-bold uppercase tracking-widest text-slate-400 hover:text-white hover:bg-slate-800 transition"
          >
            <ArrowLeft size={16} />
            Back to Store
          </Link>
